...
var roleCarry = {
    ...
    run: function(creep) {
	    ...
	    if(creep.store.getFreeCapacity() > 0) {
            var target;
            if (creep.memory.role == 'carryA') creep.memory.pickup ='5effb887c92744c2f9884259';
            else if (creep.memory.role == 'carry') creep.memory.pickup ='5f00b9bfe62a985f30fb024c';
            ...
            var target;
            if (creep.memory.role == 'carryA') creep.memory.pickup ='5effb887c92744c2f9884259';
            else if (creep.memory.role == 'carry') creep.memory.pickup ='5f00f7fcf440363b29879826';
